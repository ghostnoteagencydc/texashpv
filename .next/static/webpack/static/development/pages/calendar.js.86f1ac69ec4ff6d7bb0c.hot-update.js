...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Calender, [{
    ...
    value: function togglePopup(e, event) {
      ...
      var popup = document.querySelector('.calendar-popup'); //e is dom event
      ...
      this.setState({
        ...
        popupPosition: {
          left: elPos.left - e.currentTarget.parentElement.offsetWidth - 20 + 'px',
    ...
    value: function closePopup(e) {
      ...
      if (this.state.popUpShown && !e.target.classList.contains('custom-event-clicker') && !e.target.classList.contains('calendar-popup') && !e.target.parentElement.classList.contains('calendar-popup')) {
        this.setState({
          popUpShown: false
        });
      }
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
        ...
        style: {
          ...
          display: "".concat(this.state.popUpShown ? 'block' : 'none')
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 70
...
//# sourceMappingURL=calendar.js.86f1ac69ec4ff6d7bb0c.hot-update.js.map