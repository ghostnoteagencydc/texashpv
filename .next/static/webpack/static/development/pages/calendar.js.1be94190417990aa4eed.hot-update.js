          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.msgField.current.classList.add('msg-field-shown', 'msg-error'); // this.msgField.current.classList.add('calendar-add-msg')
                // this.msgField.current.classList.add('msg-field')
              ...
              case 21:
                ...
                this.msgField.current.classList.add('msg-field-shown');
                this.msgField.current.classList.add('msg-error');
...
//# sourceMappingURL=calendar.js.1be94190417990aa4eed.hot-update.js.map