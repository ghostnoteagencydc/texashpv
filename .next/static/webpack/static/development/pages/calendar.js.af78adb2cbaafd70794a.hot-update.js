      ...
      if (this.props.events) {
        var parsed = this.props.events.map(function (e) {
          ...
          var obj = {
            ...
            start: moment__WEBPACK_IMPORTED_MODULE_7___default()(e.acf.start, 'YYYY-MM-DD H:i:s').toDate(),
            end: moment__WEBPACK_IMPORTED_MODULE_7___default()(e.acf.end, 'YYYY-MM-DD H:i:s').toDate()
          };
          console.log(obj);
          return obj;
        });
...
//# sourceMappingURL=calendar.js.af78adb2cbaafd70794a.hot-update.js.map