...
var Resources = function Resources(props) {
  ...
  }), props.resources.forEach(function (item) {
    var termClasses = [];

    if (item.terms) {
      item.terms.forEach(function (term) {
        termClasses.push(term.slug);
      });
    }

    var termClassesString = termClasses.join(' ');
    console.log(termClassesString);
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
      href: item.permalink,
      className: "resource-item ".concat(termClassesString),
      key: item.id,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 36
...
//# sourceMappingURL=resources.js.811b2aa6e62ad382bf57.hot-update.js.map