      ...
      if (this.props.events) {
        var parsed = this.props.events.map(function (e) {
          var obj = {
            ...
            start: moment__WEBPACK_IMPORTED_MODULE_7___default()(e.acf.start, 'YYYY-MM-DD').toDate(),
            end: moment__WEBPACK_IMPORTED_MODULE_7___default()(e.acf.end, 'YYYY-MM-DD').toDate()
          };
          console.log(obj);
          return obj;
        });
...
//# sourceMappingURL=calendar.js.47933e98e4cd3d93b587.hot-update.js.map