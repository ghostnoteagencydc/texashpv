    ...
    value: function render() {
      ...
      if (this.props.data) {
        return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
          ...
          onClick: function onClick() {
            return _this.openShareBox("https://www.facebook.com/sharer/sharer.php?u=".concat(encodeURI(window.location.href), "&quote=").concat(encodeURI(_this.props.data.title)));
          },
          __source: {
            fileName: _jsxFileName,
            lineNumber: 51
...
//# sourceMappingURL=post.js.efee9d879f0f314fb526.hot-update.js.map