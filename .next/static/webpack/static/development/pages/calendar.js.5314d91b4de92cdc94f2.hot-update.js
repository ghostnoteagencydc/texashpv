...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Calender, [{
    ...
    value: function closePopup(e) {
      if (this.state.popUpShown && !e.target.classList.contains('custom-event-clicker') && !e.target.classList.contains('calendar-popup')) {
        this.setState({
          popUpShown: false
        });
      }
...
//# sourceMappingURL=calendar.js.5314d91b4de92cdc94f2.hot-update.js.map