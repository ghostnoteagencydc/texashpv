      ...
      if (this.props.events) {
        var parsed = this.props.events.map(function (e) {
          if (e.acf && e.acf.approved) {
            console.log(moment__WEBPACK_IMPORTED_MODULE_8___default()(e.acf.start).toDate());
            var sConv = moment__WEBPACK_IMPORTED_MODULE_8___default()(e.acf.start).format('YYYY-MM-DD HH:mm:ss');
            var eConv = moment__WEBPACK_IMPORTED_MODULE_8___default()(e.acf.end).format('YYYY-MM-DD HH:mm:ss');
            console.log(new Date(eConv));
            var obj = {
              id: e.id,
              title: e.title,
              allDay: e.acf.all_day,
              start: new Date(sConv),
              end: new Date(eConv),
...
//# sourceMappingURL=calendar.js.52734dfd8a309bebfccb.hot-update.js.map